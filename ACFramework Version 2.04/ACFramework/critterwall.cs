...
namespace ACFramework
{
    ...
    class cCritterMovingWall : cCritter
    {
        ...
        public static readonly float CORNERJIGGLEKICK = 1.15f;
        public static readonly Color WALLFILLCOLOR = Color.LightGray;
        public static bool _placement = false;
        public const float WALLPRISMDZ = 0.75f; //Default z-depth to use for drawing cCritterWall.
        protected Color _defaultfillcolor;
        protected cRealBox3 _pskeleton;

        public void moveWall(cVector3 direction)
        {
            this.moveTo(this.Position.add(direction));
        }
        ...
        public cCritterMovingWall(cVector3 enda)
            : base(null)
        {
            _pskeleton = null;
            _defaultfillcolor = WALLFILLCOLOR;
        ...
        public cCritterMovingWall(cVector3 enda, cVector3 endb)
            : base(null)
        {
            _pskeleton = null;
            _defaultfillcolor = WALLFILLCOLOR;
        ...
        public cCritterMovingWall(cVector3 enda, cVector3 endb, float thickness = THICKNESS,
            float height = WALLPRISMDZ, cGame pownergame = null)
            : base(pownergame)
        {
            _pskeleton = null;
        ...
        public cCritterMovingWall(cVector3 enda, cVector3 endb, float thickness, cGame pownergame)
            : base(pownergame)
        {
            _pskeleton = null;
            _defaultfillcolor = WALLFILLCOLOR;
